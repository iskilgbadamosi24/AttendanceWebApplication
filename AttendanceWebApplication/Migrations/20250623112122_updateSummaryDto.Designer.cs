...
namespace AttendanceWebApplication.Migrations
{
    ...
    [Migration("20250623112122_updateSummaryDto")]
    partial class updateSummaryDto
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AttendanceWebApplication.Models.AttendanceSummaryViewModel", b =>
                {
                    ...
                    b.Property<double?>("TotalNotScannedPercentage")
                        .HasColumnType("float");

                    b.Property<int?>("TotalReturningNotInAttendanceCount")
                        .HasColumnType("int");

                    b.Property<int?>("TotalScannedCount")
                        .HasColumnType("int");

                    b.Property<double?>("TotalScannedPercentange")
                        .HasColumnType("float");
